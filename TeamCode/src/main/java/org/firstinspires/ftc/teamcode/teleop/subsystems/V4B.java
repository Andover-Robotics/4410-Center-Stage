...
public class V4B {
    ...
    public static double armOuttake = 0.31, armTopOuttake = 0.33, armStorage = 0.84, armGround = 0.08, armTopPixel = 0.88, armBottomPixel = 0.91, armDualPickup = 0.94;
    public static double wristBottomOuttake = 0.49, wristTopOuttake = 0.54,  wristStorage = 0.23, wristGround = 0.36, wristTopPixel = 0.245, wristBottomPixel = 0.24, wristDualPickup = 0.23, wristTransfer = 0.22;
