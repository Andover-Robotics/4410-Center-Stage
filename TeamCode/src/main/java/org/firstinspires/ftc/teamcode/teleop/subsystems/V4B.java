...
public class V4B {
    ...
    public static double armBottomOuttake = 0.70, armTopOuttake = 0.69, autoArmBottomOuttake = 0.75, autoArmTopOuttake = 0.74, armStorage = 0.3, armGround = 0.88, armDualPickup = 0.18, armBlock = 0.3;
